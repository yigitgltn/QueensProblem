...
public class QueensProblem {
    ...
    public static void main(String[] args) {
        ...
        while (climb) {
            QueensProblem board = new QueensProblem(
                    new int[TOTAL_QUEENS][TOTAL_QUEENS], new int[8]);
            // randomly place queens
            board.placeQueens();
            System.out.println("Deneme #: " + (climbCount + 1));
            System.out.println("Orginal tahta:");
            board.printBoard();
            System.out.println("# Vezirlerin birbirini tehtid etme sayısı: "
                    + board.h() + "\n");
            ...
            for (int j = 0; j < board.board.length; j++) {
                System.out.println("Sütun için yineleme " + j + ":");
                best = false;
                ...
                if (best) {
                    ...
                    System.out.println("En iyi iterasyon: ");
                    board.printBoard();
                    System.out.println("# Vezirlerin birbirini tehtid etme sayısı: "
                            + board.h() + "\n");
                } else {
                    System.out.println("Daha iyi dizilim bulunamadı.");
                    board.printBoard();
                    System.out.println("# Vezirlerin birbirini tehtid etme sayısı: "
                            + board.h() + "\n");
                }
    ...
    public QueensProblem(int[][] board, int[] positions) {
